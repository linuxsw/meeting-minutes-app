...
- Name: AI Configuration Page Tests >> should not show API key input for No AI
- Location: /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:38:7
...
Call log:
  - waiting for locator('select[name="aiProvider"]')
    ...
    at /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:39:16
```
