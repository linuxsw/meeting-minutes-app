...
- Name: Navigation Tests >> should navigate to Test Transcript page
- Location: /home/ubuntu/meeting-minutes-app/tests/e2e/navigation.spec.ts:26:7
...
Locator: locator('h1:has-text("Test Transcript Processing")')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('h1:has-text("Test Transcript Processing")')

    at /home/ubuntu/meeting-minutes-app/tests/e2e/navigation.spec.ts:28:77
```
