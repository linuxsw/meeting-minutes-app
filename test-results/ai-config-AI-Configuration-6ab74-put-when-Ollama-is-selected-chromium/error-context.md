...
- Name: AI Configuration Page Tests >> should show Ollama base URL input when Ollama is selected
- Location: /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:31:7
...
Call log:
  - waiting for locator('select[name="aiProvider"]')

    at /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:32:16
```
