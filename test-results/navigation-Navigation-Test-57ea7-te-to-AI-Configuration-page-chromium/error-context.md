...
- Name: Navigation Tests >> should navigate to AI Configuration page
- Location: /home/ubuntu/meeting-minutes-app/tests/e2e/navigation.spec.ts:16:7
...
Locator: locator('h1:has-text("AI Provider Configuration")')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('h1:has-text("AI Provider Configuration")')

    at /home/ubuntu/meeting-minutes-app/tests/e2e/navigation.spec.ts:18:76
```
