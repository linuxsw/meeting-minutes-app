...
- Name: AI Configuration Page Tests >> should show API key input for Together AI when selected
- Location: /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:24:7
...
Call log:
  - waiting for locator('select[name="aiProvider"]')
    ...
    at /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:25:16
```
