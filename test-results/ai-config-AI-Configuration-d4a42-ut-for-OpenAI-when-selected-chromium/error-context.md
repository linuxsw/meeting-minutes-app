...
- Name: AI Configuration Page Tests >> should show API key input for OpenAI when selected
- Location: /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:17:7
...
Call log:
  - waiting for locator('select[name="aiProvider"]')
    ...
    at /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:18:16
```
