...
- Name: AI Configuration Page Tests >> should allow saving configuration
- Location: /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:46:7
...
Call log:
  - waiting for locator('select[name="aiProvider"]')
    ...
    at /home/ubuntu/meeting-minutes-app/tests/e2e/ai-config.spec.ts:47:16
```
